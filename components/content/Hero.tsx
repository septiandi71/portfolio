  ...
  return (
    <div className='w-full flex justify-between flex-col-reverse lg:flex-row items-center'>
      ...
      <AnimationContainer customClassName='flex flex-col items-center justify-between lg:items-start p-0 lg:pr-8'>
        ...
        <a className="bg-gray-200 hover:bg-gray-400 text-black-800 font-bold py-2 px-4 rounded inline-flex items-center" href='https://drive.google.com/file/d/1bylHv51yadbBjP3EuEzZCI52f6yeM5wa/view?usp=sharing' target='_blank'>
